...
def sift_preprocess_fingerprint(image_path):
...
def sift_match_fingerprints(img1_path, img2_path):
    img1 = sift_preprocess_fingerprint(img1_path)
    img2 = sift_preprocess_fingerprint(img2_path)
...
def sift_process_dataset(dataset_path, results_folder):
